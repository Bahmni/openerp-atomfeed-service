...
public class OpenERPSellableTypeEventWorkerTest {
    @Mock
    ...
    private OpenERPSellableTypeEventWorker worker;
    ...
    public void setUp() throws Exception {
        ...
        worker = new OpenERPSellableTypeEventWorker(feedUri, openERPClient, webClient, "https://mybahmni/");
        when(webClient.get(URI.create(eventUrl))).thenReturn(sampleProcedureJson);
    }

    @Test
    public void shouldProcessSellableTypeEvent() throws IOException {
        ...
        Assert.assertTrue(parameters.contains(new Parameter("category", "create.sellable")));
    ...
    @Test
    public void shouldUpdateAsInactiveWhenNotSellable() throws IOException {
        ...
        Assert.assertTrue(parameters.contains(new Parameter("name", "Dressing of Wound")));
        Assert.assertTrue(parameters.contains(new Parameter("uuid", "e48dd85b-fb13-4f3a-ae01-e6fd57eea6fe")));
        Assert.assertFalse(parameters.contains(new Parameter("is_active", "0")));
    }
