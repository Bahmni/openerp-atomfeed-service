...
public class DrugCategory implements  ERPParameterizable{

    private String id;
    private String name;

    private static final Logger logger = Logger.getLogger(DrugCategory.class);
    ...
    public List<Parameter> getParameters(String eventId, String feedURIForLastReadEntry, String feedURI) {
        ...
        parameters.add(new Parameter("category", "create.drug.category", "string"));
        ...
        try {
            parameters.add(new Parameter("drug_category", getLabTestAsJson(), "string"));
        } catch (IOException e) {
